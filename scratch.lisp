...
(define-symbol-macro *dark-blue* (values 5 5 80))
(define-symbol-macro *yellow* (values 255 255 20))

(defparameter *test-image-1*
  (let* ((height 200)
         (width 300)
         (img (make-8-bit-rgb-image height width)))
    (multiple-value-call #'fill-image img *dark-blue*)
    (multiple-value-call #'draw-triangle img 10 100 50 250 160 70 *yellow*)
